...
@section('title', 'Editar Usuario - Sara Palma')
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('document_type_id') is-invalid @enderror" 
                        ...
                        @foreach($documentTypes as $type)
                            <option value="{{ $type->id }}" {{ old('document_type_id', $user->document_type_id) == $type->id ? 'selected' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('document_number') is-invalid @enderror" 
                           id="document_number" name="document_number" value="{{ old('document_number', $user->document_number) }}" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('finca_id') is-invalid @enderror" 
                        ...
                        @foreach($fincas as $finca)
                            <option value="{{ $finca->id }}" {{ old('finca_id', $user->finca_id) == $finca->id ? 'selected' : '' }}>
